          ...
          <div className="space-y-4">
            <Link to="/" className="inline-block" data-testid="footer-logo">
              <span className="text-2xl font-extrabold font-heading">
                ...
                <span className="text-[#00D9FF]">beds</span>
              </span>
            </Link>
            <div className="space-y-3 text-sm text-gray-300">
              <div className="flex items-start space-x-2">
                <MapPin className="h-4 w-4 mt-0.5 flex-shrink-0 text-[#00D9FF]" />
                <span>Klaićeva 14, 10 000 Zagreb<br />Croatia</span>
              </div>
              <div className="flex items-center space-x-2">
                <Phone className="h-4 w-4 flex-shrink-0 text-[#00D9FF]" />
                <span>+385 97 612 8621</span>
              </div>
              <div className="flex items-center space-x-2">
                <Mail className="h-4 w-4 flex-shrink-0 text-[#00D9FF]" />
          ...
          <div>
            ...
            <form onSubmit={handleNewsletterSubmit} className="flex space-x-2" data-testid="newsletter-form">
              <Input
                ...
                className="bg-white/10 border-white/20 text-white placeholder:text-gray-400 focus:border-[#00D9FF]"
                data-testid="newsletter-email-input"
                required
              />
              <Button 
                type="submit" 
                className="bg-transparent hover:bg-transparent text-[#00D9FF] hover:text-[#00D9FF]/80 font-semibold px-4"
        ...
        <div className="border-t border-white/10 mt-12 pt-8 flex flex-col md:flex-row justify-between items-center space-y-4 md:space-y-0">
          ...
          <div className="flex items-center space-x-6">
            ...
            <button
              ...
              className="text-sm text-gray-500 hover:text-[#00D9FF] underline-offset-4 hover:underline"
            >
            ...
            {isCmsAdmin && (
              <button
                ...
                className="text-sm text-gray-500 hover:text-[#00D9FF] flex items-center gap-1"
                title="Edit Footer"
              >
        ...
        {cmsLoginOpen && !isCmsAdmin && (
          <div className="mt-4 w-full md:w-auto md:self-end bg-white/5 border border-white/10 rounded-lg p-4 flex flex-col md:flex-row md:items-end gap-3">
            ...
            <Button
              type="button"
              size="sm"
              className="bg-[#00D9FF] hover:bg-[#00A399] text-white px-4"
