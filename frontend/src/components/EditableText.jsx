  ...
  if (isEditing && !onFocus) {
    ...
    return (
      <InputComponent
        ...
        className={cn(
          'bg-white border-2 border-[#00BFB3] rounded px-2 py-1 outline-none',
  ...
  return (
    <Component
      ...
      className={cn(
        ...
        'hover:outline hover:outline-2 hover:outline-[#00BFB3] hover:outline-offset-2',
        'hover:bg-[#00BFB3]/5 rounded',
        isActive && 'outline outline-2 outline-[#00BFB3] outline-offset-2 bg-[#00BFB3]/10',
        className
      )}
      title="Click to edit"
    >
      ...
      {isEditMode && (
        <span className={cn(
          'absolute -top-2 -right-2 w-5 h-5 bg-[#00BFB3] rounded-full',
  ...
  return (
    <div
      ...
      className={cn(
        ...
        'hover:outline hover:outline-2 hover:outline-dashed hover:outline-[#00BFB3]/50',
        isActive && 'outline outline-2 outline-dashed outline-[#00BFB3]',
        className
      )}
    >
      {/* Section label badge */}
      <div className={cn(
        ...
        'bg-[#00BFB3] text-white opacity-0 transition-opacity',
