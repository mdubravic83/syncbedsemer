    ...
    <div data-testid="about-page">
        ...
        <div className="container mx-auto px-4 md:px-6">
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div className="space-y-6">
              <span className="inline-block text-[#00BFB3] text-xs md:text-sm font-semibold tracking-wider uppercase">{heroBadge}</span>
            ...
            <div>
              ...
              <div className="space-y-4">
                <div className="flex items-center space-x-3">
                  <div className="w-6 h-6 bg-[#00BFB3] rounded-full flex items-center justify-center flex-shrink-0">
        ...
        <div className="container mx-auto px-4 md:px-6">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
            <div className="bg-white p-6 rounded-xl border border-gray-100 hover:shadow-lg transition-all duration-300">
              <div className="w-12 h-12 bg-[#00BFB3]/10 rounded-lg flex items-center justify-center mb-4">
                <Lightbulb className="h-6 w-6 text-[#00BFB3]" />
              </div>
            ...
            <div className="bg-white p-6 rounded-xl border border-gray-100 hover:shadow-lg transition-all duration-300">
              <div className="w-12 h-12 bg-[#00BFB3]/10 rounded-lg flex items-center justify-center mb-4">
                <Users className="h-6 w-6 text-[#00BFB3]" />
              </div>
      ...
      <section className="py-16 md:py-24 bg-[#0A1628]" data-testid="about-cta-section">
        <div className="container mx-auto px-4 md:px-6 text-center">
          ...
          <Button className="bg-[#00BFB3] hover:bg-[#00A399] text-white font-semibold py-6 px-10 rounded-lg text-lg" data-testid="about-cta-button">{t('cta.button')}</Button>
        </div>
      </section>
