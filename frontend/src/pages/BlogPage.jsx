      ...
      <section className="py-8 bg-white border-b border-gray-100" data-testid="blog-filters">
        <div className="container mx-auto px-4 md:px-6">
          ...
          <form onSubmit={handleSearch} className="flex flex-col md:flex-row gap-4 mb-6">
            ...
            <Button 
              type="submit"
              className="bg-[#00BFB3] hover:bg-[#00A399] text-white"
              ...
              <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
                {currentPosts.map((post) => (
                  ...
                  >
                    ...
                    <div className="p-6">
                      <span className="text-[#00BFB3] text-xs font-semibold uppercase">
                        {post.category}
                      </span>
                      <h3 className="text-lg font-semibold font-heading text-[#0A1628] mt-2 mb-2 group-hover:text-[#00BFB3] transition-colors line-clamp-2">
                        {getLocalizedContent(post.title)}
                      </h3>
                      <p className="text-gray-600 text-sm mb-4 line-clamp-3">
                        {getLocalizedContent(post.excerpt)}
                      </p>
                      <span className="text-[#00BFB3] text-sm font-medium inline-flex items-center">
                        {t('blog.readMore')}
                ...
                <div className="flex justify-center items-center space-x-2 mt-12" data-testid="blog-pagination">
                  ...
                  {Array.from({ length: Math.min(totalPages, 5) }, (_, i) => i + 1).map((page) => (
                    <Button
                      ...
                      className={currentPage === page ? 'bg-[#00BFB3] hover:bg-[#00A399]' : ''}
                    >
                      {page}
                    </Button>
                  ))}
