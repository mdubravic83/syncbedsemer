          ...
          <div className="grid lg:grid-cols-2 gap-12">
            ...
            <div className="space-y-8">
              ...
              <div className="space-y-4">
                <div className="flex items-start space-x-4">
                  <div className="w-10 h-10 bg-[#00BFB3]/10 rounded-lg flex items-center justify-center flex-shrink-0">
                    <MapPin className="h-5 w-5 text-[#00BFB3]" />
                  </div>
                  <div>
                ...
                <div className="flex items-start space-x-4">
                  <div className="w-10 h-10 bg-[#00BFB3]/10 rounded-lg flex items-center justify-center flex-shrink-0">
                    <Phone className="h-5 w-5 text-[#00BFB3]" />
                  </div>
                  <div>
                ...
                <div className="flex items-start space-x-4">
                  <div className="w-10 h-10 bg-[#00BFB3]/10 rounded-lg flex items-center justify-center flex-shrink-0">
                    <Mail className="h-5 w-5 text-[#00BFB3]" />
                  </div>
                  <div>
            ...
            <div className="bg白 rounded-xl shadow-lg p-8 border border-gray-100">
              ...
              <form onSubmit={handleSubmit} className="space-y-6" data-testid="contact-form">
                ...
                <Button 
                  type="submit"
                  className="w-full bg-[#00BFB3] hover:bg-[#00A399] text-white py-6"
